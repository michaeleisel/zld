...
// CHECK: simple_pointer_types.cpp:[[@LINE+2]]:13: warning: 'a' has incompatible definitions
// CHECK: simple_pointer_types.cpp:[[@LINE+1]]:8: note: variable 'a' has type 'int *' here
extern int *a;
#else
// CHECK: simple_pointer_types.cpp:[[@LINE+1]]:8: note: variable 'a' has type 'short *' here
extern short *a;
#endif
