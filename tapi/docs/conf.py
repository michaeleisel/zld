...
# built documents.
#
# This will intentionally create a conflict when the number is bumped upstream.
# It should serve as a reminder to check the value in the current stable branch.
...
confluence_space_name = 'TAPI'
confluence_server_url = 'https://confluence.sd.apple.com/'
confluence_parent_page = 'Documentation'

# auto generation job need to inject following key
