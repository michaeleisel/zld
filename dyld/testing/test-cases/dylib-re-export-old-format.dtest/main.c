...
// BUILD(macos|x86_64):   $CC main.c -mmacosx-version-min=10.5 -o $BUILD_DIR/dylib-re-export.exe $BUILD_DIR/libfoo.dylib -L$BUILD_DIR $DEPENDS_ON $BUILD_DIR/libbar.dylib
